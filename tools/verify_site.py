...
def main() -> None:
    ...
    for phrase in [
        ...
        "0.1.0-preview.8",
        "4,788,012 bytes / 4.79 MB",
        "6,916,223 bytes / 6.92 MB",
        "29069d730ce6c82aaeeee036920dd4de603071de5dbc0f31724d1c48b24eafef",
        "b6b5b14cf4b82809b1e1622c5df62086386db2eea307543bf032303ea51bcbd4",
        "7e4a54cb820d788e81c303ea8ec35c9281a0a1cd",
        "Windows x64",
        "Linux x64",
        "Public preview",
        "C API",
        "Python package",
        "https://downloads.nexatom.in/docs/",
        "examples/sdk",
        "C++",
        "Download for Windows",
        "Download for Linux",
        ...
        "digital input delays through 256 ns",
        "One instrument is active at a time.",
        "Kintex and legacy Zynq hardware qualification",
        "external analog validation, remain pending",
        "Firmware safety note",
        "https://github.com/nexatom-research/nexatom-downloads/releases/download/nexatomtt-sdk-v0.1.0-preview.8/nexatomtt-sdk-v0.1.0-preview.8-windows-x64.zip",
        "https://github.com/nexatom-research/nexatom-downloads/releases/download/nexatomtt-sdk-v0.1.0-preview.8/nexatomtt-sdk-v0.1.0-preview.8-linux-x64.tar.gz",
        "https://github.com/nexatom-research/nexatom-downloads/releases/tag/nexatomtt-sdk-v0.1.0-preview.8",
    ...
    if "data-release-pending" in sdk or "data-release-available hidden" in sdk:
        fail("qualified SDK download is still marked unavailable")
    page_checks = {
